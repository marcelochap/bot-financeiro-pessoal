...
const SAL = [{ pessoa: "Pessoa A", salario: 15000 }, { pessoa: "Pessoa B", salario: 3000 }];
...
const LANC_GASTOS = [
  ...
  { data_competencia: "05/03/2025", valor: 8000, tipo: "entrada", status: "confirmado", categoria: "Deposito Pessoa A", origem: "conta" },
];
...
teste("montarRelatorio: compõe gastos, rateio, fixas e link", () => {
  ...
  assert.ok(texto.includes("Pessoa A") && texto.includes("Pessoa B")); // rateio
