...
const codigoProcessarERenderizar = baseSrc + "\n" + [
  ...
  "let rateioInicio = (cfgInicio && String(cfgInicio.valor).trim()) || '';",
  "// Sheets coage '01/2026' (USER_ENTERED) para serial de data — normaliza serial -> 'MM/YYYY'.",
  "if (/^\\d+$/.test(rateioInicio)) rateioInicio = mesDe(rateioInicio) || '';",
  "const rateio = rateioAcumulado(lancamentos, salariosConfig, mesPassado, rateioInicio);",
